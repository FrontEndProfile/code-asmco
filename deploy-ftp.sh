...
FTP_USER="code@asmco.company"
FTP_PASS='zxcvbnm123$$$codi'

REMOTE_DIR=""
LOCAL_DIR="dist/asmco-tech/browser"
...
run_level () {
  ...
  echo "▶ Running: npx ng build && npm run prebuild"
  npx ng build
...
echo "   OR "
echo "   bash -lc '~/public_html/deploy-server.sh'"
