...
export class TestimonialsComponent implements OnInit {
  testimonials: Testimonial[] = [
    {
      quoteHtml:
        'Fazal was enthusiastic and <strong>ready to jump right in to several projects ranging from UI and visual design to QA work on some of our mobile applications.</strong> Fazal worked well with the team, and was also able to work autonomously when needed. I look forward to seeing what Fazal\'s next UX endeavor will be!”',
      authorLine:
    ...
    {
      quoteHtml:
        '“With the help of Fazal designs, <strong>our e-commerce site went from outdated, and underused to an additional point of sale that has allowed us to reach customers virtually that we wouldn’t have been able to reach previously.</strong> At every step of the way Fazal was professional, dedicated, and a complete pleasure to work with.”',
    ...
    {
      quoteHtml:
        'Fazal is a very talented and hard-working designer... <strong>We found Fazal to be extremely professional and easy to work with. Without question, we would hire her again.”</strong>',
